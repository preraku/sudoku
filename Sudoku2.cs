...
//                System.Console.ReadKey(true);
                ...
                // print cells where possibilities are two ..
                    aClass.printMiniSquarePossibilities2(pv, 0, 3, 3, 6);
        ...
        void printSolution2(string[,] grid, List<int> sI, List<int> sJ, List<string> value)
        {
            ...
            // char readFromUser = 'T';
            // if (readFromUser != 'F') {}
            System.Console.Write("\nPress \"F\" for final solution, \"S\" for solution + all steps at once, or any other key to step through: ");
            char readFromUser = ((char)Console.Read());
            readFromUser = Char.ToUpper(readFromUser);
            ...
            for (int iteration = 0; iteration < sI.Count; iteration++)
            {
                ...
                if ((readFromUser != 'S') || (readFromUser != 'F')) {
                    System.Console.Write("\nPress \"F\" for final solution, \"S\" for solution + all steps at once, or any other key to step through: ");
                    readFromUser = ((char)Console.Read());
                    readFromUser = Char.ToUpper(readFromUser);
                    // System.Console.ReadKey(true);s
